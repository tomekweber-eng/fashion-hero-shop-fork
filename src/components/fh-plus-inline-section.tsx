...
export function FhPlusInlineSection() {
  ...
  if (selectedPrice !== null) {
    return (
      <section className="mb-10 relative overflow-hidden rounded-lg border border-cream-dark bg-cream-light p-8 text-center">
        <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-100 px-3 py-1 text-[10px] font-medium uppercase tracking-[0.6px] text-charcoal mb-4">
          <span className="h-1.5 w-1.5 rounded-full bg-amber-500" />
          Pakiet {selectedPrice} PLN / rok
        </span>
        <h3 className="text-[20px] md:text-[24px] font-light text-charcoal leading-tight mb-2">
  ...
  return (
    <section className="mb-10 relative overflow-hidden rounded-lg border border-cream-dark bg-cream-light p-6 md:p-7">
      ...
      <div className="relative">
        <div className="mb-5 max-w-2xl">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-charcoal/10 px-3 py-1 text-[10px] font-medium uppercase tracking-[0.6px] text-charcoal mb-3">
            <span className="h-1.5 w-1.5 rounded-full bg-amber-500" />
            Nowość · FH+
          </span>
          <h2 className="text-[20px] md:text-[24px] font-light leading-snug text-charcoal mb-2">
            Dodaj FH+ do tego zamówienia
          </h2>
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-1.5 mb-6 max-w-2xl">
          {BUNDLE.map((b) => (
            <li key={b} className="flex items-start gap-2 text-[12px] text-charcoal">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {PLANS.map((plan) => {
            ...
            return (
              <div
                key={plan.price}
                className={`relative flex flex-col p-4 rounded-lg border bg-white transition-all ${
                  isFeatured
        ...
        <p className="text-[11px] text-warm-gray/70 mt-4">
